...
# 		: Brocade features added by Frank Bulk ( frnkblk AT iname.com )
...
#
# brocade ________: Brocade Networks : Fan, power supply, temperature
# brocadeFCX _____: Brocade Networks FCX series : Fan, power supply, temperature
# brocadeVDX _____: Brocade Networks VD/FCX series : Fan, power supply, temperature
# brocadeTurboIron: Brocade Networks/Foundry TurboIron series : Fan, power supply, temperature
...
# version 0.91: - brocade MLX/MLXe/XMR support added
#		- brocade FCX support support added
#		- brocade VDX support support added
# version 0.92: - brocade TurboIron support added
#
# ============================================================================
# ============================== LICENCE =====================================
# ============================================================================
...
use warnings;
use strict;
use Net::SNMP qw(snmp_dispatcher oid_lex_sort :asn1);
use Getopt::Long;
...
# Brocade MLX/MLXe/XMR (FOUNDRY-SN-AGENT-MIB) tested on 5.100c
my $brocade_chas_product_type		= "1.3.6.1.4.1.1991.1.1.1.1.26.0";
my $brocade_temp_table 			= "1.3.6.1.4.1.1991.1.1.2.13.1"; 	# Module/sensor temperature in Deg C *2
my $brocade_temp_desc 			= "1.3.6.1.4.1.1991.1.1.2.13.1.1.3"; 	# Module temp description
my $brocade_temp_value 			= "1.3.6.1.4.1.1991.1.1.2.13.1.1.4"; 	# Module temp value
my $brocade_temp_mgmt_module_high	= "1.3.6.1.4.1.1991.1.1.2.13.2.1.3.1.4";# Management module/sensor high temperature in Deg C
my $brocade_temp_mgmt_module_low	= "1.3.6.1.4.1.1991.1.1.2.13.2.1.4.1.1";# Management module/sensor low temperature in Deg C
my $brocade_temp_slave_module_high	= "1.3.6.1.4.1.1991.1.1.2.13.2.1.3.2.4";# Module/sensor high temperature in Deg C
my $brocade_temp_slave_module_low	= "1.3.6.1.4.1.1991.1.1.2.13.2.1.4.2.1";# Module/sensor low temperature in Deg C
my $brocade_temp_sf_module_high		= "1.3.6.1.4.1.1991.1.1.2.13.2.1.3.3.4";# Module/sensor high temperature in Deg C
my $brocade_temp_sf_module_low		= "1.3.6.1.4.1.1991.1.1.2.13.2.1.4.3.1";# Module/sensor low temperature in Deg C
my $brocade_ps_table			= "1.3.6.1.4.1.1991.1.1.1.2.1"; 	# PS table
my $brocade_ps_desc			= "1.3.6.1.4.1.1991.1.1.1.2.1.1.2"; 	# PS desc
my $brocade_ps_status			= "1.3.6.1.4.1.1991.1.1.1.2.1.1.3"; 	# PS status
my $brocade_fan_table			= "1.3.6.1.4.1.1991.1.1.1.3.1"; 	# FAN table
my $brocade_fan_desc			= "1.3.6.1.4.1.1991.1.1.1.3.1.1.2"; 	# FAN desc
my $brocade_fan_status			= "1.3.6.1.4.1.1991.1.1.1.3.1.1.3"; 	# FAN status
my @brocade_status 			= (3,0,2); 				# oper status : 1:other, 2: Normal, 3: Failure 
my $brocade_brd_table			= "1.3.6.1.4.1.1991.1.1.2.2.1.1"; 	# Brocade redundancy table
my $brocade_brd_desc			= "1.3.6.1.4.1.1991.1.1.2.2.1.1.2"; 	# Brocade redundancy board description string
my $brocade_brd_module_status		= "1.3.6.1.4.1.1991.1.1.2.2.1.1.12"; 	# Brocade redundancy board module status
my $brocade_brd_redundant_status	= "1.3.6.1.4.1.1991.1.1.2.2.1.1.13"; 	# Brocade redundancy board redundancy status
my $brocade_brd2_table			= "1.3.6.1.4.1.1991.1.1.2.2.2"; 	# Brocade redundancy 2 table
my $brocade_brd2_desc			= "1.3.6.1.4.1.1991.1.1.2.2.2.1.3"; 	# Brocade redundancy 2 board description string
my $brocade_brd2_module_status		= "1.3.6.1.4.1.1991.1.1.2.2.2.1.6"; 	# Brocade redundancy 2 board module status
my $brocade_brd2_redundant_status	= "1.3.6.1.4.1.1991.1.1.2.2.2.1.7"; 	# Brocade redundancy 2 board redundancy status

# Brocade FCX (FOUNDRY-SN-AGENT-MIB) tested on IronWare 7.0.01bT7f3
my $brocadeFCX_chas_product_type	= "1.3.6.1.4.1.1991.1.1.1.1.26.0";
my $brocadeFCX_chas_actual_temp		= "1.3.6.1.4.1.1991.1.1.1.4.1.1.4.1"; 	# Chassis temperature in Deg C *2
my $brocadeFCX_chas_warning_temp	= "1.3.6.1.4.1.1991.1.1.1.4.1.1.5.1"; 	# Chassis temperature in Deg C *2
my $brocadeFCX_chas_shutdown_temp	= "1.3.6.1.4.1.1991.1.1.1.4.1.1.6.1"; 	# Chassis temperature in Deg C *2

my $brocadeFCX_chas_unit_temp_table	= "1.3.6.1.4.1.1991.1.1.1.4.1"; 	# Chassis temperature in Deg C *2
my $brocadeFCX_chas_unit_actual_temp	= "1.3.6.1.4.1.1991.1.1.1.4.1.1.4";	# Chassis temperature in Deg C *2
my $brocadeFCX_chas_unit_warning_temp	= "1.3.6.1.4.1.1991.1.1.1.4.1.1.5";	# Chassis temperature in Deg C *2
my $brocadeFCX_chas_unit_shutdown_temp	= "1.3.6.1.4.1.1991.1.1.1.4.1.1.6";	# Chassis temperature in Deg C *2

my $brocadeFCX_agent_temp_table 	= "1.3.6.1.4.1.1991.1.1.2.13.3";	# Agent temperature in Dec C * 2
my $brocadeFCX_agent_temp_desc		= "1.3.6.1.4.1.1991.1.1.2.13.3.1.4";	# Agent temperature in Dec C * 2
my $brocadeFCX_agent_temp_value		= "1.3.6.1.4.1.1991.1.1.2.13.3.1.5";	# Agent temperature in Dec C * 2

my $brocadeFCX_ps_table			= "1.3.6.1.4.1.1991.1.1.1.2.1";		# PS table
my $brocadeFCX_ps_desc			= "1.3.6.1.4.1.1991.1.1.1.2.1.1.2"; 	# PS desc
my $brocadeFCX_ps_status		= "1.3.6.1.4.1.1991.1.1.1.2.1.1.3"; 	# PS status

my $brocadeFCX_ps2_table		= "1.3.6.1.4.1.1991.1.1.1.2.2";		# PS2 table
my $brocadeFCX_ps2_desc			= "1.3.6.1.4.1.1991.1.1.1.2.2.1.3"; 	# PS2 desc
my $brocadeFCX_ps2_status		= "1.3.6.1.4.1.1991.1.1.1.2.2.1.4"; 	# PS2 status

my $brocadeFCX_fan_table		= "1.3.6.1.4.1.1991.1.1.1.3.2"; 	# FAN table
my $brocadeFCX_fan_desc			= "1.3.6.1.4.1.1991.1.1.1.3.2.1.3"; 	# FAN desc
my $brocadeFCX_fan_status		= "1.3.6.1.4.1.1991.1.1.1.3.2.1.4"; 	# FAN status

my $brocadeFCX_brd2_table		= "1.3.6.1.4.1.1991.1.1.2.2.2"; 	# Brocade redundancy 2 table
my $brocadeFCX_brd2_desc		= "1.3.6.1.4.1.1991.1.1.2.2.2.1.3"; 	# Brocade redundancy 2 board description string
my $brocadeFCX_brd2_module_status	= "1.3.6.1.4.1.1991.1.1.2.2.2.1.6"; 	# Brocade redundancy 2 board module status
my $brocadeFCX_brd2_redundant_status	= "1.3.6.1.4.1.1991.1.1.2.2.2.1.7"; 	# Brocade redundancy 2 board redundancy status

# Brocade VDX 
my $brocadeVDX_chas_product_type	= "1.3.6.1.2.1.1.1.0";

my $brocadeVDX_sensor_table		= "1.3.6.1.4.1.1588.2.1.1.1.1.22";	# Sensor table
my $brocadeVDX_sensor_type		= "1.3.6.1.4.1.1588.2.1.1.1.1.22.1.2"; 	# Sensor type
my $brocadeVDX_sensor_status		= "1.3.6.1.4.1.1588.2.1.1.1.1.22.1.3"; 	# Sensor status
my $brocadeVDX_sensor_value		= "1.3.6.1.4.1.1588.2.1.1.1.1.22.1.4"; 	# Sensor value
my $brocadeVDX_sensor_desc		= "1.3.6.1.4.1.1588.2.1.1.1.1.22.1.5"; 	# Sensor desc/info

# Brocade TurboIron (FOUNDRY-SN-AGENT-MIB) tested on IronWare 7.4.00T203
my $brocadeTurboIron_chas_product_type		= "1.3.6.1.4.1.1991.1.1.1.1.26.0";
my $brocadeTurboIron_chas_actual_temp		= "1.3.6.1.4.1.1991.1.1.1.1.18.0"; 	# Chassis temperature in Deg C *2
my $brocadeTurboIron_chas_warning_temp		= "1.3.6.1.4.1.1991.1.1.1.1.19.0"; 	# Chassis temperature in Deg C *2
my $brocadeTurboIron_chas_shutdown_temp		= "1.3.6.1.4.1.1991.1.1.1.1.20.0"; 	# Chassis temperature in Deg C *2

my $brocadeTurboIron_agent_temp_table 		= "1.3.6.1.4.1.1991.1.1.2.13.1";	# Agent temperature in Dec C * 2
my $brocadeTurboIron_agent_temp_desc		= "1.3.6.1.4.1.1991.1.1.2.13.1.1.3";	# Agent temperature in Dec C * 2
my $brocadeTurboIron_agent_temp_value		= "1.3.6.1.4.1.1991.1.1.2.13.1.1.4";	# Agent temperature in Dec C * 2

my $brocadeTurboIron_ps_table			= "1.3.6.1.4.1.1991.1.1.1.2.1";		# PS table
my $brocadeTurboIron_ps_desc			= "1.3.6.1.4.1.1991.1.1.1.2.1.1.2"; 	# PS desc
my $brocadeTurboIron_ps_status			= "1.3.6.1.4.1.1991.1.1.1.2.1.1.3"; 	# PS status

my $brocadeTurboIron_fan_table			= "1.3.6.1.4.1.1991.1.1.1.3.1"; 	# FAN table
my $brocadeTurboIron_fan_desc			= "1.3.6.1.4.1.1991.1.1.1.3.1.1.2"; 	# FAN desc
my $brocadeTurboIron_fan_status			= "1.3.6.1.4.1.1991.1.1.1.3.1.1.3"; 	# FAN status

my $brocadeTurboIron_brd_table			= "1.3.6.1.4.1.1991.1.1.2.2.1"; 	# Brocade redundancy table
my $brocadeTurboIron_brd_desc			= "1.3.6.1.4.1.1991.1.1.2.2.1.1.2"; 	# Brocade redundancy board description string
my $brocadeTurboIron_brd_module_status		= "1.3.6.1.4.1.1991.1.1.2.2.1.1.12"; 	# Brocade redundancy board module status
my $brocadeTurboIron_brd_redundant_status	= "1.3.6.1.4.1.1991.1.1.2.2.1.1.13"; 	# Brocade redundancy board redundancy status

my $brocadeTurboIron_config_module_table	= "1.3.6.1.4.1.1991.1.1.2.8.1"; 	# Brocade configuratiom module table
my $brocadeTurboIron_config_module_desc		= "1.3.6.1.4.1.1991.1.1.2.8.1.1.4"; 	# Brocade configuration module description string
my $brocadeTurboIron_config_module_status	= "1.3.6.1.4.1.1991.1.1.2.8.1.1.5"; 	# Brocade configuration module status
...
my $iron_tmp_celsius			= "1.3.6.1.4.1.15497.1.1.1.9.1.2"; 	# temp in celsius
...
my $Version		= '0.92';	# Version number of this script
...
my @valid_types		= ("brocade","brocadeFCX","brocadeVDX","brocadeTurboIron","cisco","nokia","bc","iron","foundry","linux","ciscoSW","extremeSW","juniper","procurve","netscreen","ciscoNEW","citrix","transmode");	
...
sub print_usage {
    print "Usage: $0 [-v] -H <host> [-6] -C <snmp_community> [-2] | (-l login -x passwd [-X pass -L <authp>,<privp>])  [-p <port>] -T (brocade|brocadeFCX|brocadeVDX|brocadeTurboIron|cisco|ciscoSW|ciscoNEW|nokia|bc|iron|foundry|linux|extremeSW|juniper|procurve|netscreen|citrix|transmode) [-F <rpm>] [-c <celsius>] [-f] [-t <timeout>] [-V]\n";
}
...
-T, --type=brocade|brocadeFCX|brocadeVDX|brocadeTurboIron|cisco|ciscoSW|ciscoNEW|nokia|bc|iron|foundry|linux|extremeSW|juniper|procurve|netscreen|citrix|transmode
   Environmental check : 
	brocade ________: Brocade Networks : Fan, power supply, temperature
	brocadeFCX _____: Brocade Networks FCX series : Fan, power supply, temperature
	brocadeVDX _____: Brocade Networks VDX series : Fan, power supply, temperature
	brocadeTurboIron: Brocade Networks/Foundry TurboIron series : Fan, power supply, temperature
	cisco __________: Cisco Systems : Fan, power-supply, voltage, temperature
	ciscoSW ________: Cisco Systems : Card and module status check
...
-c, --celsius=<celsius>
   Maximum temp in degree celsius (only needed for 'iron' & 'linux')
-f, --perfparse
...
if ( ($voltexist ==0) && ($tempexist ==0) && ($fanexist ==0) && ($psexist ==0) ) {
  print "No Environmental data found : UNKNOWN \n";
  exit $ERRORS{"UNKNOWN"};
}
...
if ($o_check_type eq "brocade") {

verb("Checking brocade env");

verb("Checking model");
my $snChasProductType = snmp_get_request($session, $brocade_chas_product_type);
if ($snChasProductType eq '66') {
	print "Please use type brocadeFCX or brocadeTurboIron\n";
	exit $ERRORS{"UNKNOWN"};
}
...
my $result_ps =  $session->get_table(Baseoid => $brocade_ps_table);
&check_snmp_result($result_ps,$session->error);

my $ps_num=0;
if (defined($result_ps)) {
	$output .=", " if defined($output);
	foreach my $key (sort keys %$result_ps) {
		verb("OID : $key, Desc : $$result_ps{$key}");
		if ($key =~ /$brocade_ps_desc/) {
			$ps_num++;
			my @oid_list = split (/\./,$key); 
			my $ps = pop (@oid_list); 
			my $index_ps= $brocade_ps_status . "." . $ps;
			verb("index position: $index_ps");
			if (defined ($$result_ps{$index_ps})) {
				if ($$result_ps{$index_ps} == 3) {
					$output.="PS ".$ps." : FAILURE; ";
					$global_status=3;
				}
...
my $result_fan =  $session->get_table(Baseoid => $brocade_fan_table);
&check_snmp_result($result_fan,$session->error);

my $fan_num=0;
if (defined($result_fan)) {
	foreach my $key (oid_lex_sort(keys %$result_fan)) {
		verb("OID : $key, Desc : $$result_fan{$key}");
		if ($key =~ /$brocade_fan_desc/) {
			my $fan_description = $$result_fan{$key};
			$fan_num++;
			if ($fan_num % 2) {
				$output .="\n";
			}
			my @oid_list = split (/\./,$key); 
			my $fan = pop (@oid_list); 
			my $index_fan= $brocade_fan_status . "." . $fan;
			if (defined ($$result_fan{$index_fan})) {
				if ($$result_fan{$index_fan} == 3) {
					$output .= "$fan_description (" . $fan . "): FAILURE; ";
					$global_status=3;
				}
				elsif ($$result_fan{$index_fan} == 2) {
					$global_status=1 if ($global_status==0);
					$output .= "$fan_description (" . $fan . "): OK; ";
				}
				else {
					$output .= "$fan_description (" . $fan . "): OTHER; ";
				}
			}
			else {
				$output .= "$fan_description (" . $fan . "): UNDEFINED STATUS; ";
			} 
		}
	}
}
...
my $result_temp =  $session->get_table(Baseoid => $brocade_temp_table);
&check_snmp_result($result_temp,$session->error);

my $temp_num=0;
if (defined($result_temp)) {
	foreach my $key (oid_lex_sort(keys %$result_temp)) {
		verb("OID : $key, Desc : $$result_temp{$key}");
		if ($key =~ /$brocade_temp_desc/) {
			$output .="\n";
			$temp_num++;
			my $temp_high;
			my $temp_low;
			my $temp_description = $$result_temp{$key};
			my @oid_list = split (/\./,$key); 
			my $sensor = pop (@oid_list); 
			my $module = pop (@oid_list); 
			my $index_temp = $brocade_temp_value . "." . $module . "." . $sensor;
			if ($temp_description =~ /management module/) {
				$temp_high = snmp_get_request($session, $brocade_temp_mgmt_module_high);
				$temp_low = snmp_get_request($session, $brocade_temp_mgmt_module_low);
			}
			# slave modules also includes line modules
			if ($temp_description =~ /Line module/) {
				$temp_high = snmp_get_request($session, $brocade_temp_slave_module_high);
				$temp_low = snmp_get_request($session, $brocade_temp_slave_module_low);
			}
			if ($temp_description =~ /Switch Fabric/) {
				$temp_high = snmp_get_request($session, $brocade_temp_sf_module_high);
				$temp_low = snmp_get_request($session, $brocade_temp_sf_module_low);
			}
			my $current_temp = $$result_temp{$index_temp} / 2;
			if (defined($current_temp) && defined($temp_high) && defined($temp_low)) {
				if ($current_temp == 0) {
					$output .= "$temp_description of $current_temp\xB0C suggests that this sensor is erroneous; ";
				}
				elsif ($current_temp >= $temp_high) {
					$output .= "$temp_description of $current_temp\xB0C: exceeds max of $temp_high\xB0C: CRITICAL; ";
					$global_status=3;
				}
				elsif ($current_temp >= $temp_high - 15) {
					$output .= "$temp_description of $current_temp\xB0C: approaching max of $temp_high\xB0C: WARNING; ";
					$global_status=2 if ($global_status!=3);
				}
				elsif ($current_temp <= $temp_low) {
					$output .= "$temp_description of $current_temp\xB0C: below minimum of $temp_low\xB0C: CRITICAL; ";
					$global_status=3;
				}
				elsif ($current_temp <= $temp_low + 15) {
					$output .= "$temp_description of $current_temp\xB0C: approaching low of $temp_low\xB0C: WARNING; ";
					$global_status=2 if ($global_status!=3);
				}
				else {
					$global_status=1 if ($global_status==0);
					$output .= "$temp_description of $current_temp\xB0C: OK; ";
				}
			}
			else {
				$output .= "$temp_description: UNDEFINED STATUS; ";
			} 
		}
	}
}

# Get Brocade redundancy table

my $result_brd =  $session->get_table(Baseoid => $brocade_brd_table);
&check_snmp_result($result_brd,$session->error);

if (defined($result_brd)) {
	foreach my $key (oid_lex_sort(keys %$result_brd)) {
		verb("OID : $key, Desc : $$result_brd{$key}");
		if ($key =~ /$brocade_brd_desc\./) {
			my $brd_description = $$result_brd{$key};
			my @oid_list = split (/\./,$key); 
			my $slot = pop (@oid_list); 
			my $index_brd_module= $brocade_brd_module_status . "." . $slot;
			my $index_brd_redundant= $brocade_brd_redundant_status . "." . $slot;
			if ($$result_brd{$index_brd_module} ne 0) {
				$output .="\n";
				$output .= "Slot $slot ($brd_description): ";

				if ($$result_brd{$index_brd_module} == 2) {
					$output .= "Module status: GOING DOWN; ";
					$global_status=3;
				}
				elsif ($$result_brd{$index_brd_module} == 3) {
					$output .= "Module status: REJECTED; ";
					$global_status=3;
				}
				elsif ($$result_brd{$index_brd_module} == 4) {
					$output .= "Module status: BAD; ";
					$global_status=3;
				}
				elsif ($$result_brd{$index_brd_module} == 8) {
					$output .= "Module status: CONFIGURED; ";
					$global_status=2 if ($global_status!=3);
				}
				elsif ($$result_brd{$index_brd_module} == 9) {
					$output .= "Module status: COMING UP; ";
					$global_status=2 if ($global_status!=3);
				}
				elsif ($$result_brd{$index_brd_module} == 10) {
					$output .= "Module status: OK; ";
				}
				else {
					$output .= "Module status: OTHER; ";
				}

				if ($$result_brd{$index_brd_redundant} == 5) {
					$output .= "Redundant status: COMING UP; ";
					$global_status=3;
				}
				elsif ($$result_brd{$index_brd_redundant} == 4) {
					$output .= "Redundant status: CRASHED; ";
					$global_status=3;
				}
				elsif ($$result_brd{$index_brd_redundant} == 3) {
					$global_status=1 if ($global_status==0);
					$output .= "Redundant status: OK (standby); ";
				}
				elsif ($$result_brd{$index_brd_redundant} == 2) {
					$global_status=1 if ($global_status==0);
					$output .= "Redundant status: OK (active); ";
				}
				elsif ($$result_brd{$index_brd_redundant} == 1) {
					$global_status=1 if ($global_status==0);
					$output .= "Redundant status: OK (other); ";
				}
				else {
					$output .= "Redundant status: OTHER; ";
				}
			}
		}
	}
...
# Get Brocade redundancy 2 table

my $result_brd2 =  $session->get_table(Baseoid => $brocade_brd2_table);
&check_snmp_result($result_brd2,$session->error);

if (defined($result_brd2)) {
	foreach my $key (oid_lex_sort(keys %$result_brd2)) {
		verb("OID : $key, Desc : $$result_brd2{$key}");
		if ($key =~ /$brocade_brd2_desc/) {
			my $brd2_description = $$result_brd2{$key};
			my @oid_list = split (/\./,$key); 
			my $slot = pop (@oid_list); 
			my $unit = pop (@oid_list); 
			my $index_brd2_module= $brocade_brd2_module_status . "." . $unit . "." . $slot;
			my $index_brd2_redundant= $brocade_brd2_redundant_status . "." . $unit . "." . $slot;
			if ($$result_brd2{$index_brd2_module} ne 0) {
				$output .="\n";
				$output .= "Module $unit-$slot ($brd2_description): ";

				if ($$result_brd2{$index_brd2_module} == 2) {
					$output .= "Module status: GOING DOWN; ";
					$global_status=3;
				}
				elsif ($$result_brd2{$index_brd2_module} == 3) {
					$output .= "Module status: REJECTED; ";
					$global_status=3;
				}
				elsif ($$result_brd2{$index_brd2_module} == 4) {
					$output .= "Module status: BAD; ";
					$global_status=3;
				}
				elsif ($$result_brd2{$index_brd2_module} == 8) {
					$output .= "Module status: CONFIGURED; ";
					$global_status=2 if ($global_status!=3);
				}
				elsif ($$result_brd2{$index_brd2_module} == 9) {
					$output .= "Module status: COMING UP; ";
					$global_status=2 if ($global_status!=3);
				}
				elsif ($$result_brd2{$index_brd2_module} == 10) {
					$output .= "Module status: OK; ";
				}
				else {
					$output .= "Module status: OTHER; ";
				...
				if ($$result_brd2{$index_brd2_redundant} == 5) {
					$output .= "Redundant status: COMING UP; ";
					$global_status=3;
				}
				elsif ($$result_brd2{$index_brd2_redundant} == 4) {
					$output .= "Redundant status: CRASHED; ";
					$global_status=3;
				}
				elsif ($$result_brd2{$index_brd2_redundant} == 3) {
					$global_status=1 if ($global_status==0);
					$output .= "Redundant status: OK (standby); ";
				}
				elsif ($$result_brd2{$index_brd2_redundant} == 2) {
					$global_status=1 if ($global_status==0);
					$output .= "Redundant status: OK (active); ";
				}
				elsif ($$result_brd2{$index_brd2_redundant} == 1) {
					$global_status=1 if ($global_status==0);
					$output .= "Redundant status: OK (other); ";
				}
				else {
...
if (($ps_num+$fan_num+$temp_num) == 0) {
  print  "\nNo data found : UNKNOWN\n";
  exit $ERRORS{"UNKNOWN"};
}
...
if ($o_check_type eq "brocadeFCX") {

verb("Checking brocadeFCX env");

verb("Checking model");
my $snChasProductType = snmp_get_request($session, $brocadeFCX_chas_product_type);
if ($snChasProductType =~ /18|19|20|21/) {
	print "Please use type brocade\n";
	exit $ERRORS{"UNKNOWN"};
}
...
my $result_ps =  $session->get_table(Baseoid => $brocadeFCX_ps_table);
&check_snmp_result($result_ps,$session->error);
...
if (defined($result_ps)) {
	...
	foreach my $key (sort keys %$result_ps) {
		verb("OID : $key, Desc : $$result_ps{$key}");
		if ($key =~ /$brocadeFCX_ps_desc/) {
			my $ps_desc = $$result_ps{$key};
			chop $ps_desc;
			$ps_num++;
			my @oid_list = split (/\./,$key); 
			my $ps = pop (@oid_list); 
			my $index_ps= $brocadeFCX_ps_status . "." . $ps;
			verb("index position: $index_ps");
			if (defined ($$result_ps{$index_ps})) {
				if ($$result_ps{$index_ps} == 3) {
					$output .= "PS $ps ($ps_desc): FAILURE; ";
					$global_status=3;
				}
				elsif ($$result_ps{$index_ps} == 2) {
					$global_status=1 if ($global_status==0);
					$output .= "PS $ps ($ps_desc): OK; ";
				}
				else {
					$output .= "PS $ps ($ps_desc): OTHER; ";
				}
			}
			else {
				$output .= "PS " . $$result_ps{$key} . " : UNDEFINED STATUS; ";    
...
my $result_ps2 =  $session->get_table(Baseoid => $brocadeFCX_ps2_table);
&check_snmp_result($result_ps2,$session->error);

$ps_num=0;
if (defined($result_ps2)) {
	$output .="\n" if defined($output);
	foreach my $key (sort keys %$result_ps2) {
		verb("OID : $key, Desc : $$result_ps2{$key}");
		if ($key =~ /$brocadeFCX_ps2_desc/) {
			my $ps_desc = $$result_ps2{$key};
			$ps_num++;
			my @oid_list = split (/\./,$key); 
			my $ps = pop (@oid_list); 
			my $unit = pop (@oid_list); 
			my $index_ps= $brocadeFCX_ps2_status . "." . $unit . "." . $ps;
			verb("index position: $index_ps");
			if (defined ($$result_ps2{$index_ps})) {
				if ($$result_ps2{$index_ps} == 3) {
					$output .= "PS $ps-$unit ($ps_desc): FAILURE; ";
					$global_status=3;
				}
				elsif ($$result_ps2{$index_ps} == 2) {
					$global_status=1 if ($global_status==0);
					$output .= "PS $ps-$unit ($ps_desc): OK; ";
				}
				else {
					$output .= "PS $ps-$unit ($ps_desc): OTHER; ";
				}
			}
			else {
				$output .= "PS " . $$result_ps2{$key} . " : UNDEFINED STATUS; ";    
			} 
		}
	}
}
...
my $result_fan =  $session->get_table(Baseoid => $brocadeFCX_fan_table);
&check_snmp_result($result_fan,$session->error);
...
if (defined($result_fan)) {
	foreach my $key (oid_lex_sort(keys %$result_fan)) {
		...
		if ($key =~ /$brocadeFCX_fan_desc/) {
			...
			my $fan = pop (@oid_list); 
			my $unit = pop (@oid_list); 
			my $index_fan= $brocadeFCX_fan_status . "." . $unit . "." . $fan;
			if (defined ($$result_fan{$index_fan})) {
				if ($$result_fan{$index_fan} == 3) {
					$output .= "$fan_description (" . $fan . "): FAILURE; ";
					$global_status=3;
...
# Get Chassis Temperature
my $chas_actual_temp = snmp_get_request($session, $brocadeFCX_chas_actual_temp) / 2;
my $chas_warning_temp = snmp_get_request($session, $brocadeFCX_chas_warning_temp) / 2;
my $chas_shutdown_temp = snmp_get_request($session, $brocadeFCX_chas_shutdown_temp) / 2;
if ($chas_actual_temp >= $chas_shutdown_temp) {
	$output .= "\nChassis temperature of $chas_actual_temp\xB0C: exceeds shutdown temperature of $chas_shutdown_temp\xB0C: CRITICAL; ";
	$global_status=3;
}
elsif ($chas_actual_temp >= $chas_warning_temp) {
	$output .= "\nChassis temperature of $chas_actual_temp\xB0C: exceeds warning temperature of $chas_warning_temp\xB0C: WARNING; ";
	$global_status=2 if ($global_status!=3);
}
else {
	$global_status=1 if ($global_status==0);
	$output .= "\nChassis temperature of $chas_actual_temp\xB0C: OK; ";
}

# Get Chassis Unit temperature table

my $result_temp =  $session->get_table(Baseoid => $brocadeFCX_chas_unit_temp_table);
&check_snmp_result($result_temp,$session->error);
...
if (defined($result_temp)) {
	foreach my $key (oid_lex_sort(keys %$result_temp)) {
		verb("OID : $key, Desc : $$result_temp{$key}");
		if ($key =~ /$brocadeFCX_chas_unit_temp_table\.\d+\.1\.1$/) {
			$output .="\n";
			$temp_num++;
			my @oid_list = split (/\./,$key); 
			pop (@oid_list); 
			pop (@oid_list); 
			my $slot = pop (@oid_list); 
			my $index_temp = $brocadeFCX_chas_unit_temp_table . "." . $slot;
			my $chas_unit_actual = $$result_temp{$index_temp . ".4.1"} / 2;
			my $chas_unit_warning = $$result_temp{$index_temp . ".5.1"} / 2;
			my $chas_unit_shutdown = $$result_temp{$index_temp . ".6.1"} / 2;
			if ($chas_unit_actual >= $chas_unit_shutdown) {
				$output .= "Chassis unit temperature of $chas_unit_actual\xB0C: exceeds shutdown temperature of $chas_unit_shutdown\xB0C: CRITICAL; ";
				$global_status=3;
			}
			elsif ($chas_unit_actual >= $chas_warning_temp) {
				$output .= "Chassis unit temperature of $chas_unit_actual\xB0C: exceeds warning temperature of $chas_unit_warning\xB0C: WARNING; ";
				$global_status=2 if ($global_status!=3);
			}
			else {
				$global_status=1 if ($global_status==0);
				$output .= "Chassis unit temperature of $chas_unit_actual\xB0C: OK; ";
			}
		}
	}
}

# Get Agent temperature table

$result_temp =  $session->get_table(Baseoid => $brocadeFCX_agent_temp_table);
&check_snmp_result($result_temp,$session->error);
...
if (defined($result_temp)) {
	foreach my $key (oid_lex_sort(keys %$result_temp)) {
		verb("OID : $key, Desc : $$result_temp{$key}");
		if ($key =~ /$brocadeFCX_agent_temp_desc/) {
			$output .="\n";
			$temp_num++;
			my $temp_description = $$result_temp{$key};
			my @oid_list = split (/\./,$key); 
			...
			my $slot = pop (@oid_list); 
			my $unit = pop (@oid_list); 
			my $index_temp = $brocadeFCX_agent_temp_value . "." . $unit . "." . $slot . "." . "$index";
			my $current_temp = $$result_temp{$index_temp} / 2;
			if (defined($current_temp)) {
				if ($current_temp >= $chas_shutdown_temp) {
					$output .= "$temp_description of $current_temp\xB0C: exceeds chassis shutdown temperature $chas_shutdown_temp\xB0C: CRITICAL; ";
					$global_status=3;
				}
				elsif ($current_temp >= $chas_warning_temp) {
					$output .= "$temp_description of $current_temp\xB0C: exceeds chassis warning temperature of $chas_warning_temp\xB0C: WARNING; ";
					$global_status=2 if ($global_status!=3);
				}
				else {
					$global_status=1 if ($global_status==0);
...
# Get Brocade FCX redundancy 2 table

my $resultFCX_brd2 =  $session->get_table(Baseoid => $brocadeFCX_brd2_table);
&check_snmp_result($resultFCX_brd2,$session->error);

if (defined($resultFCX_brd2)) {
	foreach my $key (oid_lex_sort(keys %$resultFCX_brd2)) {
		verb("OID : $key, Desc : $$resultFCX_brd2{$key}");
		if ($key =~ /$brocadeFCX_brd2_desc/) {
			my $brd2_description = $$resultFCX_brd2{$key};
			my @oid_list = split (/\./,$key); 
			my $slot = pop (@oid_list); 
			my $unit = pop (@oid_list); 
			my $indexFCX_brd2_module= $brocadeFCX_brd2_module_status . "." . $unit . "." . $slot;
			my $indexFCX_brd2_redundant= $brocadeFCX_brd2_redundant_status . "." . $unit . "." . $slot;
			if ($$resultFCX_brd2{$indexFCX_brd2_module} ne 0) {
				$output .="\n";
				$output .= "Module $unit-$slot ($brd2_description): ";

				if ($$resultFCX_brd2{$indexFCX_brd2_module} == 2) {
					$output .= "Module status: GOING DOWN; ";
					$global_status=3;
				}
				elsif ($$resultFCX_brd2{$indexFCX_brd2_module} == 3) {
					$output .= "Module status: REJECTED; ";
					$global_status=3;
				}
				elsif ($$resultFCX_brd2{$indexFCX_brd2_module} == 4) {
					$output .= "Module status: BAD; ";
					$global_status=3;
				}
				elsif ($$resultFCX_brd2{$indexFCX_brd2_module} == 8) {
					$output .= "Module status: CONFIGURED; ";
					$global_status=2 if ($global_status!=3);
				}
				elsif ($$resultFCX_brd2{$indexFCX_brd2_module} == 9) {
					$output .= "Module status: COMING UP; ";
					$global_status=2 if ($global_status!=3);
				}
				elsif ($$resultFCX_brd2{$indexFCX_brd2_module} == 10) {
					$output .= "Module status: OK; ";
				}
				else {
					$output .= "Module status: OTHER; ";
				...
				if ($$resultFCX_brd2{$indexFCX_brd2_redundant} == 5) {
					$output .= "Redundant status: COMING UP; ";
					$global_status=3;
				}
				elsif ($$resultFCX_brd2{$indexFCX_brd2_redundant} == 4) {
					$output .= "Redundant status: CRASHED; ";
					$global_status=3;
				}
				elsif ($$resultFCX_brd2{$indexFCX_brd2_redundant} == 3) {
					$global_status=1 if ($global_status==0);
					$output .= "Redundant status: OK (standby); ";
				}
				elsif ($$resultFCX_brd2{$indexFCX_brd2_redundant} == 2) {
					$global_status=1 if ($global_status==0);
					$output .= "Redundant status: OK (active); ";
				}
				elsif ($$resultFCX_brd2{$indexFCX_brd2_redundant} == 1) {
					$global_status=1 if ($global_status==0);
					$output .= "Redundant status: OK (other); ";
				}
				else {
...
if ($o_check_type eq "brocadeVDX") {

verb("Checking brocadeVDX env");

verb("Checking model");
my $snChasProductType = snmp_get_request($session, $brocadeVDX_chas_product_type);
if ($snChasProductType !~ /Brocade VDX/) {
	print "Please use another type\n";
	exit $ERRORS{"UNKNOWN"};
}
...
my $result_sensor =  $session->get_table(Baseoid => $brocadeVDX_sensor_table);
&check_snmp_result($result_sensor,$session->error);

$sensor_num=0;
if (defined($result_sensor)) {
	$output .=", " if defined($output);
	# power supplies
	foreach my $key (sort keys %$result_sensor) {
		verb("OID : $key, Desc : $$result_sensor{$key}");
		if (($key =~ /$brocadeVDX_sensor_type/) && ($$result_sensor{$key} eq 3)) {
			$sensor_num++;
			my @oid_list = split (/\./,$key); 
			my $sensor = pop (@oid_list); 
			my $index_sensor= $brocadeVDX_sensor_status . "." . $sensor;
			my $sensor_desc = $$result_sensor{$brocadeVDX_sensor_desc . "." . $sensor};
			$sensor_desc =~ s/ (.*)/$1/g;
			$sensor_desc =~ s/(.*) /$1/g;
			verb("index position: $index_sensor");
			if (defined ($$result_sensor{$index_sensor})) {
				if ($$result_sensor{$index_sensor} == 1) {
					$output .= "$sensor_desc: UNKNOWN; ";
					$global_status=3;
				}
				elsif ($$result_sensor{$index_sensor} == 2) {
					$output .= "$sensor_desc: FAULTY; ";
					$global_status=3;
				}
				elsif ($$result_sensor{$index_sensor} == 3) {
					$output .= "$sensor_desc: BELOW MINIMUM; ";
					$global_status=3;
				}
				elsif ($$result_sensor{$index_sensor} == 4) {
					$output .= "$sensor_desc: OK; ";
					$global_status=1 if ($global_status==0);
				}
				elsif ($$result_sensor{$index_sensor} == 5) {
					$output .= "$sensor_desc: ABOVE MAXIMUM; ";
					$global_status=3;
				}
				elsif ($$result_sensor{$index_sensor} == 6) {
					$output .= "$sensor_desc: ABSENT; ";
					$global_status=2 if ($global_status <= 1);
				}
				else {
					$output .= "$sensor_desc): OTHER; ";
				}
			}
			else {
				$output .= "PS " . $$result_sensor{$key} . " : UNDEFINED STATUS; ";    
			} 
		}
	}
	# fans
	...
	foreach my $key (sort keys %$result_sensor) {
		verb("OID : $key, Desc : $$result_sensor{$key}");
		if (($key =~ /$brocadeVDX_sensor_type/) && ($$result_sensor{$key} eq 2)) {
			$sensor_num++;
			my @oid_list = split (/\./,$key); 
			my $sensor = pop (@oid_list); 
			my $index_sensor= $brocadeVDX_sensor_status . "." . $sensor;
			my $sensor_desc = $$result_sensor{$brocadeVDX_sensor_desc . "." . $sensor};
			my $sensor_value = $$result_sensor{$brocadeVDX_sensor_value . "." . $sensor};
			$sensor_desc =~ s/ (.*)/$1/g;
			$sensor_desc =~ s/(.*) /$1/g;
			verb("index position: $index_sensor");
			if (defined ($$result_sensor{$index_sensor})) {
				if ($$result_sensor{$index_sensor} == 1) {
					$output .= "$sensor_desc: UNKNOWN ($sensor_value RPM); ";
					$global_status=3;
				}
				elsif ($$result_sensor{$index_sensor} == 2) {
					$output .= "$sensor_desc: FAULTY ($sensor_value RPM); ";
					$global_status=3;
				}
				elsif ($$result_sensor{$index_sensor} == 3) {
					$output .= "$sensor_desc: BELOW MINIMUM ($sensor_value RPM); ";
					$global_status=3;
				}
				elsif ($$result_sensor{$index_sensor} == 4) {
					$output .= "$sensor_desc: OK ($sensor_value RPM); ";
					$global_status=1 if ($global_status==0);
				}
				elsif ($$result_sensor{$index_sensor} == 5) {
					$output .= "$sensor_desc: ABOVE MAXIMUM ($sensor_value RPM); ";
					$global_status=3;
				}
				elsif ($$result_sensor{$index_sensor} == 6) {
					$output .= "$sensor_desc: ABSENT ($sensor_value RPM); ";
					$global_status=2 if ($global_status <= 1);
				}
				else {
					$output .= "PS ($sensor_desc): OTHER; ";
				}
			}
			else {
				$output .= "PS " . $$result_sensor{$key} . " : UNDEFINED STATUS; ";    
	...
	foreach my $key (sort keys %$result_sensor) {
		verb("OID : $key, Desc : $$result_sensor{$key}");
		if (($key =~ /$brocadeVDX_sensor_type/) && ($$result_sensor{$key} eq 1)) {
			$sensor_num++;
			my @oid_list = split (/\./,$key); 
			my $sensor = pop (@oid_list); 
			my $index_sensor= $brocadeVDX_sensor_status . "." . $sensor;
			...
			if (defined ($$result_sensor{$index_sensor})) {
				if ($$result_sensor{$index_sensor} == 1) {
					$output .= "$sensor_desc: UNKNOWN ($sensor_value Celsius); ";
					$global_status=3;
				}
				elsif ($$result_sensor{$index_sensor} == 2) {
					$output .= "$sensor_desc: FAULTY ($sensor_value Celsius); ";
					$global_status=3;
				}
				elsif ($$result_sensor{$index_sensor} == 3) {
					$output .= "$sensor_desc: BELOW MINIMUM ($sensor_value Celsius); ";
					$global_status=3;
				}
				elsif ($$result_sensor{$index_sensor} == 4) {
					$output .= "$sensor_desc: OK ($sensor_value Celsius); ";
					$global_status=1 if ($global_status==0);
				}
				elsif ($$result_sensor{$index_sensor} == 5) {
					$output .= "$sensor_desc: ABOVE MAXIMUM ($sensor_value Celsius); ";
					$global_status=3;
				}
				elsif ($$result_sensor{$index_sensor} == 6) {
					$output .= "$sensor_desc: ABSENT ($sensor_value Celsius); ";
					$global_status=2 if ($global_status <= 1);
				}
				else {
					$output .= "PS ($sensor_desc): OTHER; ";
...
if ($o_check_type eq "brocadeTurboIron") {

verb("Checking brocadeTurboIron env");

verb("Checking model");
my $snChasProductType = snmp_get_request($session, $brocadeTurboIron_chas_product_type);
if ($snChasProductType =~ /18|19|20|21/) {
	print "Please use type brocade\n";
	exit $ERRORS{"UNKNOWN"};
}
...
verb("Checking power suppy table");
my $result_ps =  $session->get_table(Baseoid => $brocadeTurboIron_ps_table);
&check_snmp_result($result_ps,$session->error);
...
if (defined($result_ps)) {
	...
	foreach my $key (sort keys %$result_ps) {
		verb("OID : $key, Desc : $$result_ps{$key}");
		if ($key =~ /$brocadeTurboIron_ps_desc/) {
			my $ps_desc = $$result_ps{$key};
			chop $ps_desc;
			$ps_num++;
			my @oid_list = split (/\./,$key); 
			my $ps = pop (@oid_list); 
			my $index_ps= $brocadeTurboIron_ps_status . "." . $ps;
			verb("index position: $index_ps");
			if (defined ($$result_ps{$index_ps})) {
				if ($$result_ps{$index_ps} == 3) {
					$output .= "$ps_desc: FAILURE; ";
					$global_status=3;
				}
				elsif ($$result_ps{$index_ps} == 2) {
					$global_status=1 if ($global_status==0);
...
verb("Checking fan table");
my $result_fan =  $session->get_table(Baseoid => $brocadeTurboIron_fan_table);
&check_snmp_result($result_fan,$session->error);
...
if (defined($result_fan)) {
	foreach my $key (oid_lex_sort(keys %$result_fan)) {
		verb("OID : $key, Desc : $$result_fan{$key}");
		if ($key =~ /$brocadeTurboIron_fan_desc/) {
			my $fan_description = $$result_fan{$key};
			$fan_num++;
			if ($fan_num % 2) {
				$output .="\n";
			...
			my $fan = pop (@oid_list); 
			my $unit = pop (@oid_list); 
			my $index_fan= $brocadeTurboIron_fan_status . "." . $fan;
			if (defined ($$result_fan{$index_fan})) {
				if ($$result_fan{$index_fan} == 3) {
					$output .= "$fan_description (" . $fan . "): FAILURE; ";
					$global_status=3;
...
verb("Checking chassis temperature");
my $chas_actual_temp = snmp_get_request($session, $brocadeTurboIron_chas_actual_temp) / 2;
my $chas_warning_temp = snmp_get_request($session, $brocadeTurboIron_chas_warning_temp) / 2;
my $chas_shutdown_temp = snmp_get_request($session, $brocadeTurboIron_chas_shutdown_temp) / 2;
if ($chas_actual_temp >= $chas_shutdown_temp) {
	$output .= "\nChassis temperature of $chas_actual_temp\xB0C: exceeds shutdown temperature of $chas_shutdown_temp\xB0C: CRITICAL; ";
	$global_status=3;
}
...
verb("Checking agent temperature");
my $result_temp =  $session->get_table(Baseoid => $brocadeTurboIron_agent_temp_table);
&check_snmp_result($result_temp,$session->error);
...
if (defined($result_temp)) {
	foreach my $key (oid_lex_sort(keys %$result_temp)) {
		verb("OID : $key, Desc : $$result_temp{$key}");
		if ($key =~ /$brocadeTurboIron_agent_temp_desc/) {
			$output .="\n";
			$temp_num++;
			my $temp_description = $$result_temp{$key};
			my @oid_list = split (/\./,$key); 
			...
			my $slot = pop (@oid_list); 
			my $unit = pop (@oid_list); 
			my $index_temp = $brocadeTurboIron_agent_temp_value . "." . $slot . "." . "$index";
			my $current_temp = $$result_temp{$index_temp} / 2;
			if (defined($current_temp)) {
				if ($current_temp >= $chas_shutdown_temp) {
					$output .= "$temp_description of $current_temp\xB0C: exceeds chassis shutdown temperature $chas_shutdown_temp\xB0C: CRITICAL; ";
...
if ($o_check_type eq "extremeSW") {
	...
	if (defined($resultat_temp_alarm) && defined($resultat_temp_current)){
		...
		$temperature_output.= " (" . $temperature_current . " celsius)";
	}
...
sub snmp_get_request {
        ...
        my $snmp_result = $session->get_request(
                -varbindlist => [$oid]
                );

        if (!defined($snmp_result)) {
		print "\nERROR: Trying to obtain $oid. $session->error.\n";
        }

        return $snmp_result->{$oid};
}
